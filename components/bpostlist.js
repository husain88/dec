class BBlogpost extends HTMLElement {
    connectedCallback() {
      this.innerHTML = `
          <style>
          ...
          <div class="card mt-2 blog-scroll border rounded shadow-sm">
                <div class="card-header header-elements-inline">
                  <h5 class="card-title">Our Blogs - Latest News Feeds</h5>
                </div>
  
                <div class="card-body blog-scroll-body">
                  <div class="row">
                    <div class="col-xl-12">
  ...
  customElements.define("bblog-posts", BBlogpost);
